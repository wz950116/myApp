<template>
	<view class="content">
		<view class="head">
			...
			<img v-show="scrollTop > 10" src="https://wz950116.bj.bcebos.com/jx3-pve%2Fassets%2Fshadow.png" class="cloud">
		</view>
			...
			<view class="list">
				<view class="item" v-for="(item, index) in currentList" :key="item.uid">
					...
					<view class="info">
						...
						<view class="origin">马驹产出/UID&nbsp;&nbsp;[{{ item.child_uid }}]</view>
						<view class="introduct">简介&nbsp;&nbsp;{{ introductList[item.name] || '具体不详' }}</view>
					</view>
				</view>
			</view>
		</scroll-view>
